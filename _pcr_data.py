...
CHARA_NAME = {
    ...
    # =================================== #
    #喫茶ステラと死神の蝶#
    7600: ['明月栞那','明月栞那','AkizukiKanna','栞那'],
    7601: ['火打谷爱衣','火打谷愛衣','HiuchidaniMei','爱衣','打火机'],
    7602: ['四季夏目','四季ナツメ','ShikiNatsume','夏目'],
    7603: ['墨染希','墨染希','SumizomeNozomi','小希'],
    7604: ['汐山凉音','汐山涼音','ShioyamaSuzune','凉音'],
